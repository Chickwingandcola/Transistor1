...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x001Bu, /* Handle of the BAS service */ 
        0x001Du, /* Handle of the Battery Level characteristic */ 
        0x001Eu, /* Handle of the Characteristic Presentation Format descriptor */ 
