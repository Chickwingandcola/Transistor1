...
{
    0x0014u,    /* Handle of the DIS service */
    {
        0x0016u, /* Handle of the Manufacturer Name String characteristic */ 
        0x0018u, /* Handle of the Model Number String characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Serial Number String characteristic */ 
        0x001Au, /* Handle of the Hardware Revision String characteristic */ 
