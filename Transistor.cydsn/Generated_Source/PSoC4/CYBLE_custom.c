...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Custom Service service */
    {
        0x0010u, /* Handle of the Custom Service service */ 
        {
            ...
            /* Lactate characteristic */
            {
                0x0012u, /* Handle of the Lactate characteristic */ 
            ...
            {
                0x0016u, /* Handle of the Glucose Measurement characteristic */ 
            ...
            {
                0x0019u, /* Handle of the Temperature Measurement characteristic */ 
            ...
            /* PH characteristic */
            {
                0x001Cu, /* Handle of the PH characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Du, /* Handle of the Custom Descriptor descriptor */ 
