...
`ifdef WARP
`define CY_BLK_DIR "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "F:\infineon\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a8350980-e91a-4bb3-b83a-bc0dcd708677"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__AD5940_CS_net;
	wire [0:0] tmpFB_0__AD5940_CS_net;
	wire [0:0] tmpIO_0__AD5940_CS_net;
	wire [0:0] tmpINTERRUPT_0__AD5940_CS_net;
	electrical [0:0] tmpSIOVREF__AD5940_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("e1d9cb65-5e12-44d0-bd77-52416ce9fe43"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_CS
		 (.oe(tmpOE__AD5940_CS_net),
		  .y({Net_226}),
		  .fb({tmpFB_0__AD5940_CS_net[0:0]}),
		  .io({tmpIO_0__AD5940_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_CS_net),
		  .interrupt({tmpINTERRUPT_0__AD5940_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AD5940_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AD5940_EXTI_net;
	wire [0:0] tmpFB_0__AD5940_EXTI_net;
	wire [0:0] tmpIO_0__AD5940_EXTI_net;
	electrical [0:0] tmpSIOVREF__AD5940_EXTI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c8b14503-611e-4c93-9dce-3a4c1f060fd6"),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_EXTI
		 (.oe(tmpOE__AD5940_EXTI_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AD5940_EXTI_net[0:0]}),
		  .io({tmpIO_0__AD5940_EXTI_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_EXTI_net),
		  .interrupt({Net_142}),
		  .annotation({Net_164}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__AD5940_EXTI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("76d26b07-4bcd-4cde-aaf2-aec79c5b7b8d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__AD5940_MISO_net;
	wire [0:0] tmpIO_0__AD5940_MISO_net;
	wire [0:0] tmpINTERRUPT_0__AD5940_MISO_net;
	electrical [0:0] tmpSIOVREF__AD5940_MISO_net;

	cy_psoc3_pins_v1_10
		#(.id("bca6f86c-602e-45c7-805a-14899568ce23"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_MISO
		 (.oe(tmpOE__AD5940_MISO_net),
		  .y({1'b0}),
		  .fb({Net_223}),
		  .io({tmpIO_0__AD5940_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_MISO_net),
		  .interrupt({tmpINTERRUPT_0__AD5940_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AD5940_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AD5940_SCLK_net;
	wire [0:0] tmpFB_0__AD5940_SCLK_net;
	wire [0:0] tmpIO_0__AD5940_SCLK_net;
	wire [0:0] tmpINTERRUPT_0__AD5940_SCLK_net;
	electrical [0:0] tmpSIOVREF__AD5940_SCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("832be99a-93d9-486c-9f93-d3f404287aef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_SCLK
		 (.oe(tmpOE__AD5940_SCLK_net),
		  .y({Net_225}),
		  .fb({tmpFB_0__AD5940_SCLK_net[0:0]}),
		  .io({tmpIO_0__AD5940_SCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_SCLK_net),
		  .interrupt({tmpINTERRUPT_0__AD5940_SCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AD5940_SCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AD5940_MOSI_net;
	wire [0:0] tmpFB_0__AD5940_MOSI_net;
	wire [0:0] tmpIO_0__AD5940_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__AD5940_MOSI_net;
	electrical [0:0] tmpSIOVREF__AD5940_MOSI_net;

	cy_psoc3_pins_v1_10
		#(.id("bd120a5e-dab5-4448-846f-6b8a7a195dd3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_MOSI
		 (.oe(tmpOE__AD5940_MOSI_net),
		  .y({Net_224}),
		  .fb({tmpFB_0__AD5940_MOSI_net[0:0]}),
		  .io({tmpIO_0__AD5940_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__AD5940_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AD5940_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("409723aa-5c22-4728-bae2-bda56e7b7aa7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DRUG_EN_1_net;
	wire [0:0] tmpFB_0__DRUG_EN_1_net;
	wire [0:0] tmpIO_0__DRUG_EN_1_net;
	wire [0:0] tmpINTERRUPT_0__DRUG_EN_1_net;
	electrical [0:0] tmpSIOVREF__DRUG_EN_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		DRUG_EN_1
		 (.oe(tmpOE__DRUG_EN_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DRUG_EN_1_net[0:0]}),
		  .io({tmpIO_0__DRUG_EN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__DRUG_EN_1_net),
		  .interrupt({tmpINTERRUPT_0__DRUG_EN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DRUG_EN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STIM_EN_A_net;
	wire [0:0] tmpFB_0__STIM_EN_A_net;
	wire [0:0] tmpIO_0__STIM_EN_A_net;
	wire [0:0] tmpINTERRUPT_0__STIM_EN_A_net;
	electrical [0:0] tmpSIOVREF__STIM_EN_A_net;

	cy_psoc3_pins_v1_10
		#(.id("1d661c97-249b-427d-aa4e-2a377b63204c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		STIM_EN_A
		 (.oe(tmpOE__STIM_EN_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STIM_EN_A_net[0:0]}),
		  .io({tmpIO_0__STIM_EN_A_net[0:0]}),
		  .siovref(tmpSIOVREF__STIM_EN_A_net),
		  .interrupt({tmpINTERRUPT_0__STIM_EN_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STIM_EN_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AD5940_RST_net;
	wire [0:0] tmpFB_0__AD5940_RST_net;
	wire [0:0] tmpIO_0__AD5940_RST_net;
	wire [0:0] tmpINTERRUPT_0__AD5940_RST_net;
	electrical [0:0] tmpSIOVREF__AD5940_RST_net;

	cy_psoc3_pins_v1_10
		#(.id("a609c111-dafa-4834-ab4d-d0fe1a4af868"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AD5940_RST
		 (.oe(tmpOE__AD5940_RST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AD5940_RST_net[0:0]}),
		  .io({tmpIO_0__AD5940_RST_net[0:0]}),
		  .siovref(tmpSIOVREF__AD5940_RST_net),
		  .interrupt({tmpINTERRUPT_0__AD5940_RST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AD5940_RST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AMP1_EN_net;
	wire [0:0] tmpFB_0__AMP1_EN_net;
	wire [0:0] tmpIO_0__AMP1_EN_net;
	wire [0:0] tmpINTERRUPT_0__AMP1_EN_net;
	electrical [0:0] tmpSIOVREF__AMP1_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("970e63b3-883c-4a1d-97e8-20b885c9f0ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AMP1_EN
		 (.oe(tmpOE__AMP1_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AMP1_EN_net[0:0]}),
		  .io({tmpIO_0__AMP1_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__AMP1_EN_net),
		  .interrupt({tmpINTERRUPT_0__AMP1_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AMP1_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AMP2_EN_net;
	wire [0:0] tmpFB_0__AMP2_EN_net;
	wire [0:0] tmpIO_0__AMP2_EN_net;
	wire [0:0] tmpINTERRUPT_0__AMP2_EN_net;
	electrical [0:0] tmpSIOVREF__AMP2_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("1d1344ae-5cd5-4eda-8e60-51dc5450bde8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AMP2_EN
		 (.oe(tmpOE__AMP2_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AMP2_EN_net[0:0]}),
		  .io({tmpIO_0__AMP2_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__AMP2_EN_net),
		  .interrupt({tmpINTERRUPT_0__AMP2_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AMP2_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__AMP3_EN_net;
	wire [0:0] tmpFB_0__AMP3_EN_net;
	wire [0:0] tmpIO_0__AMP3_EN_net;
	wire [0:0] tmpINTERRUPT_0__AMP3_EN_net;
	electrical [0:0] tmpSIOVREF__AMP3_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("cdfd8f98-044d-4211-9db4-6b76a858ee2e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		AMP3_EN
		 (.oe(tmpOE__AMP3_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__AMP3_EN_net[0:0]}),
		  .io({tmpIO_0__AMP3_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__AMP3_EN_net),
		  .interrupt({tmpINTERRUPT_0__AMP3_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AMP3_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
