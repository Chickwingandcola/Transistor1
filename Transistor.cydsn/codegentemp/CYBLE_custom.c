...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Custom Service service */
    {
        0x0010u, /* Handle of the Custom Service service */ 
        {
            ...
            {
                0x0017u, /* Handle of the Glucose Measurement characteristic */ 
            ...
            {
                0x001Bu, /* Handle of the Temperature Measurement characteristic */ 
            ...
            /* URIC_ACID characteristic */
            {
                0x001Fu, /* Handle of the URIC_ACID characteristic */ 
