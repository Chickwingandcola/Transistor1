    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x94u] = {
    /* Device Name */
    (uint8)'H', (uint8)'e', (uint8)'a', (uint8)'r', (uint8)'t', (uint8)' ', (uint8)'R', (uint8)'a', (uint8)'t',
    (uint8)'e', (uint8)' ', (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r',
    ...
    /* Custom Descriptor */
    0x00u, 0x00u, 0xFCu, 0xD8u, 0xABu, 0x49u, 0x16u, 0x6Eu, 0x8Au, 0x66u, 0x4Fu, 0xB1u, 0x09u, 0x3Au, 0xA6u, 0xD0u,
    0x56u,

    /* Characteristic User Description */
    (uint8)'L', (uint8)'a', (uint8)'c', (uint8)'t', (uint8)'a', (uint8)'t', (uint8)'e', (uint8)' ', (uint8)'(',
    (uint8)'m', (uint8)'m', (uint8)'o', (uint8)'l', (uint8)'/', (uint8)'L', (uint8)')',

    /* Glucose Measurement */
    0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,

    /* Characteristic User Description */
    (uint8)'G', (uint8)'l', (uint8)'u', (uint8)'c', (uint8)'o', (uint8)'s', (uint8)'e', (uint8)' ', (uint8)'(',
    (uint8)'m', (uint8)'g', (uint8)'/', (uint8)'d', (uint8)'L', (uint8)')',

    /* Temperature Measurement */
    0x00u, 0x00u, 0x00u, 0x00u, 0x00u,

    /* Characteristic User Description */
    (uint8)'T', (uint8)'e', (uint8)'m', (uint8)'p', (uint8)'e', (uint8)'r', (uint8)'a', (uint8)'t', (uint8)'u',
    (uint8)'r', (uint8)'e', (uint8)' ', (uint8)'(', (uint8)'Â', (uint8)'°', (uint8)'C', (uint8)')',

    /* URIC_ACID */
    0x00u, 0x00u,

    /* Custom Descriptor */
    0x00u, 0x63u, 0xC7u, 0x7Eu, 0xBAu, 0x3Fu, 0x4Fu, 0xE4u, 0x9Bu, 0x58u, 0x4Cu, 0x28u, 0x02u, 0x32u, 0x4Du, 0x4Au,
    0x1Bu,

    /* Characteristic User Description */
    (uint8)'U', (uint8)'R', (uint8)'I', (uint8)'C', (uint8)'_', (uint8)'A', (uint8)'C', (uint8)'I', (uint8)'D',
    (uint8)' ', (uint8)'V', (uint8)'a', (uint8)'l', (uint8)'u', (uint8)'e',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Custom Service */
    { 0xC9u, 0x6Bu, 0x1Fu, 0xFDu, 0xD9u, 0xA2u, 0x15u, 0x8Bu, 0xBAu, 0x4Cu, 0x54u, 0xEDu, 0xE5u, 0xE1u, 0x6Fu, 0x14u },
    /* Lactate */
    { 0x58u, 0x2Eu, 0x15u, 0x26u, 0xC4u, 0x23u, 0xA4u, 0x8Bu, 0x34u, 0x49u, 0x28u, 0xC0u, 0x29u, 0x83u, 0x6Fu, 0x39u },
    /* URIC_ACID */
    { 0xA7u, 0xBCu, 0x54u, 0xCFu, 0x56u, 0x37u, 0xE0u, 0xB5u, 0x44u, 0x40u, 0x4Au, 0x26u, 0x19u, 0x9Fu, 0xFDu, 0x3Bu },
};

CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    { 0x0011u, (void *)&cyBle_attValues[0] }, /* Device Name */
    { 0x0002u, (void *)&cyBle_attValues[17] }, /* Appearance */
    { 0x0008u, (void *)&cyBle_attValues[19] }, /* Peripheral Preferred Connection Parameters */
    { 0x0001u, (void *)&cyBle_attValues[27] }, /* Central Address Resolution */
    { 0x0001u, (void *)&cyBle_attValues[28] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cyBle_attValues[29] }, /* Service Changed */
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Lactate UUID */
    { 0x0001u, (void *)&cyBle_attValues[33] }, /* Lactate */
    { 0x0001u, (void *)&cyBle_attValues[34] }, /* Custom Descriptor */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attValues[51] }, /* Characteristic User Description */
    { 0x000Au, (void *)&cyBle_attValues[67] }, /* Glucose Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x000Fu, (void *)&cyBle_attValues[77] }, /* Characteristic User Description */
    { 0x0005u, (void *)&cyBle_attValues[92] }, /* Temperature Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
    { 0x0011u, (void *)&cyBle_attValues[97] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* URIC_ACID UUID */
    { 0x0002u, (void *)&cyBle_attValues[114] }, /* URIC_ACID */
    { 0x0001u, (void *)&cyBle_attValues[116] }, /* Custom Descriptor */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[8] }, /* Client Characteristic Configuration */
    { 0x000Fu, (void *)&cyBle_attValues[133] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x22u] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x01020001u /* rd     */, 0x0003u, {{0x0011u, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0015u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0012u, 0x8329u /* Lactate                             */, 0x09120003u /* rd,ntf */, 0x0015u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0013u, 0xA63Au /* Custom Descriptor                   */, 0x09000001u /*        */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0015u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0015u, {{0x0010u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0019u, {{0x2A18u, NULL}}                           },
    { 0x0017u, 0x2A18u /* Glucose Measurement                 */, 0x01120003u /* rd,ntf */, 0x0019u, {{0x000Au, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0018u, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x0018u, {{0x0002u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0019u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0019u, {{0x000Fu, (void *)&cyBle_attValuesLen[15]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x001Du, {{0x2A1Cu, NULL}}                           },
    { 0x001Bu, 0x2A1Cu /* Temperature Measurement             */, 0x01120003u /* rd,ntf */, 0x001Du, {{0x0005u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x001Cu, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x001Cu, {{0x0002u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x001Du, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x001Du, {{0x0011u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Eu, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0022u, {{0x0010u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Fu, 0x9F19u /* URIC_ACID                           */, 0x09120003u /* rd,ntf */, 0x0022u, {{0x0002u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x0020u, 0x4D32u /* Custom Descriptor                   */, 0x09000001u /*        */, 0x0020u, {{0x0001u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x0021u, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x0021u, {{0x0002u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x0022u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd     */, 0x0022u, {{0x000Fu, (void *)&cyBle_attValuesLen[23]}} },
};
